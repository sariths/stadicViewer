"""
This module defines the classes for Illuminance arrays and Zones. Zones can either an electric zone or it can be the
illuminance values in a room for a point-in-time calculation like rtrace.
"""
